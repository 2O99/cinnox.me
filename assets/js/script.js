...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.com/users/354742916456906753';
      break;
    case 'youtube':
      url = 'https://www.youtube.com/channel/UCVwe4sF65Av7Mgm_iF5QwBg';
      break;
    case 'twitter':
      url = 'https://twitter.com/CINN0X';
      break;
  }
